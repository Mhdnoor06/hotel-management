    ...
    <body id="body-pd">
        ...
        <div class="l-navbar" id="nav-bar">
            <nav class="nav">
                <div>
                    <div class="nav__list">
                    <a href="javascript:void(0)" class="nav__link active tablink" onclick="openCity('admin', this, 'blue')" id="defaultOpen">
                        <i class='bx bx-layer nav__logo-icon'></i>
                        <span class="nav__logo-name">Admin Page</span>
                    </a>

                    
                        <a href="javascript:void(0)" class="nav__link tablink" onclick="openCity('booked_room', this, 'blue')">
                        <i class='bx bx-grid-alt nav__icon' ></i>
                            <span class="nav__name">Booked room</span>
                        </a>

                        <a href="javascript:void(0)" class="nav__link tablink" onclick="openCity('all_room_info', this, 'blue')">
                            <i class='far fa-address-book nav__icon' ></i>
                            <span class="nav__name">All Room Info</span>
                        </a>

                        <a href="javascript:void(0)" class="nav__link tablink" onclick="openCity('add_new_room', this, 'blue')">
                        ...
                        <a href="javascript:void(0)" class="nav__link tablink" onclick="openCity('update_room_info', this, 'blue')">
                        <i class="iconify" data-icon="dashicons:update" data-inline="false"></i>
                            <span class="nav__name">Update Room Info</span>
                        </a>
                        
                         <a href="javascript:void(0)" class="nav__link tablink" onclick="openCity('customer_info', this, 'blue')">
                            <i class='far fa-user nav__icon' ></i>
                            <span class="nav__name">Customer Info</span> 
                        </a>

                        <!-- <a href="javascript:void(0)" class="nav__link tablink" onclick="openCity('employee', this, 'blue')">
                            <i class='far fa-id-card nav__icon' ></i>
                            <span class="nav__name">Employee</span>
                        </a> -->

                        <!-- <a href="javascript:void(0)" class="nav__link tablink" onclick="openCity('employee_attendence', this, 'blue')">
                            <i class='fas fa-fingerprint nav__icon' ></i>
                            <span class="nav__name">Employee Attendence</span>
                        </a>

                        <a href="javascript:void(0)" class="nav__link tablink" onclick="openCity('expenses', this, 'blue')">
...
$( document ).ready(function() {
  ...
  $sql = "INSERT INTO room (`room_no`,`floor_no`,`room_code`,`features`,`amount`) VALUES ('$room_no','$floor_no','$room_code','$features','$amount')";
  $query_run=mysqli_query($conn,$sql);
...
$result = $conn->query($sql);
$sql1 = "CALL showing_booked_room_info_to_admin()";
$result1 = $conn->query($sql1);
$sql2 = "CALL showing_unbooked_room_info_to_admin()";
...
<table class="table table-striped table-light table-bordered" id="mytable">
          <thead class="thead-dark" ><tr>
                <th>Room No</th>
                <th>Floor No</th>
                <th>Room name</th>
...
<br>  
 <table class="table table-striped table-light table-bordered">
      ...
      echo "<script> alert('$conn->error'); </script>";
        ...
        <!-- <div id="all_cus" class="tabcntent"></div> -->
