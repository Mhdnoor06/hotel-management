...
?>
  ...
  <div class="form-group">
    ...
    <input type="number"  minlength="4" maxlength="8" class="form-control" id="contact_no" placeholder="Contact No" name="contact_no">
  </div>
  <div class="form-group">
...
?>
  ...
  elseif(isset($_POST['update'])){
    ...
    <div class="form-group">
      <label for="contact_no">Contact No</label>
      <input type="tel"   class="form-control" id="contact_no" placeholder="Contact No" name="contact_no"
...
<hr>  
  ...
  <div class="form-group">
    <label for="room_no">Enter the Room No which you want to book:</label>
...
$customer_id = $row["customer_id"];
   ...
   $query1="UPDATE room SET Status='Booked' WHERE room_no=$room_no";
